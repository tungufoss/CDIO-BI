...
\title{Enhancing Professional Competence Through Industry-Engaged Assessment in Business Intelligence}
...
\textbf{\textit{Helga Ingimundardóttir}} is an Assistant Professor of Industrial Engineering at the University of Iceland. Since 2023, her teaching and research focus on optimization, mathematical modeling, data science, artificial intelligence, and industry-engaged learning in data-intensive contexts. She is a member of the Teaching Academy of the public universities in Iceland (2024). Helga brings extensive industry experience: as a Research Scientist at \emph{deCODE Genetics} she designed a long-read sequencing analysis pipeline and co-authored work in \emph{Nature Genetics} and \emph{Genome Biology}; as a Data Scientist at \emph{CCP Games} she helped build real-time recommendation services for EVE Online; as Head of AI Research at \emph{Travelshift} she led optimization on the traveling thief problem for large-scale trip planning; and earlier, as a Computational Engineer in R\&D at \emph{Valka} (now JBT Marel), she authored an innovative fish portioning optimization program based on X-ray imagery and generalized bone-detection algorithms for multiple species. She holds a PhD and MSc in Computational Engineering and a BSc in Mathematics from the University of Iceland, plus a graduate diploma in Teaching Studies for Higher Education.
